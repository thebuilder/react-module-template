...
function generateDocs(src) {
  ...
  if (readme.includes('<!--- generated-props --->')) {
    ...
    console.log('Could not find props placeholder in readme. Skipping props generation.')
    console.log('Make sure it includes "<!--- generated-props --->" and "<!--- generated-props-end --->".')
  }
}
